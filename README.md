...
**Hardware:** Colmena (8-GPU inference hive) + Burro (overnight fine-tuning server)
...
**Hardware:** Cerebro (dedicated LocoEnsayo inference host)
...
|---------|------|-------------|
| **Colmena** | Multi-GPU inference hive, LocoBench primary | WEIHO 8-GPU enclosed chassis, floor cards per VRAM tier |
